Feature: CA - Bulk Upsert - Builder

# Users : Access : Description of Test
# Builder : EmployeeChangeApproval23 : User created the table
@Rest
Scenario: CA - As Builder, Bulk Upsert into a Link Column using ResolveLink where User is able to view all rows
	Given Cleanup Run cql statement Delete from [Mock].[EmployeeChangeApproval23] where [Cinchy Id] > 33; with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	And Cleanup Run cql statement UPDATE [Mock].[EmployeeChangeApproval23] SET [Approval State] = 'Approved' where [Cinchy Id] > 33 with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	When As User Builder Run Bulk Upsert cql from file insertChangeApprovalBulkUpsert11.txt with Parameter:Column:Type as data0:Cinchy Id:Number,data1:Job:Text,data2:Link Calculated Cache:Text,data3:Link CalculatedLink Cache:Text,data4:Manager:Text,data5:Person:Text,data6:Role:Text,data7:User:Text,data9:Id:Number
	...
	Then As User Builder Run cql statement Select [Job], [Link Calculated Cache],[Link CalculatedLink Cache],[Manager],[Person],[Role],[User],[Id] from [Mock].[EmployeeChangeApproval23] Where [Deleted] IS NULL AND (([Cinchy Id] BETWEEN @from AND @to) OR ([Id] BETWEEN 134 AND 141)); and validate unordered result resultChangeApprovalBulkUpsert105.txt with ResultFormat = CSV and QueryType = Query Approved Data and Timeout = 60 seconds
		| Name | Value |
		| from | 1     |
		| to   | 4     |
	Then As User Builder Run cql from file selectChangeApprovalBulkUpsert55.txt and validate unordered result resultChangeApprovalBulkUpsert106.txt with ResultFormat = CSV and QueryType = Including Version History and Timeout = 60 seconds
		| Name | Value |
		| from | 1     |
		| to   | 4     |

@Rest
Scenario: CA - As Builder, Bulk Upsert into a Link Column that references simple column types where User is able to view all rows
	Given Cleanup Run cql statement Delete from [Mock].[EmployeeChangeApproval23] where [Cinchy Id] > 33; with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	And Cleanup Run cql statement UPDATE [Mock].[EmployeeChangeApproval23] SET [Approval State] = 'Approved' where [Cinchy Id] > 33 with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	When As User Builder Run Bulk Upsert cql statement INSERT INTO [Mock].[EmployeeChangeApproval23] ([Cinchy Id], [Name], [Id], [Start Date], [Emergency Contact Number], [Annual Base Compensation], [Employee Term],[Salaried]) VALUES (@data1,@data2,@data3,@data4,@data5,@data6,@data7,@data8); with Parameter:Column:Type as data1:Cinchy Id:Number,data2:Name:Text,data3:Id:Number,data4:Start Date:DateTime,data5:Emergency Contact Number:Number,data6:Annual Base Compensation:Number,data7:Employee Term:Text,data8:Salaried:Boolean
	...
	Then As User Builder Run cql statement Select [Name], [Id], [Start Date], [Emergency Contact Number], [Annual Base Compensation], [Employee Term],[Salaried] from [Mock].[EmployeeChangeApproval23] Where [Deleted] IS NULL AND (([Cinchy Id] BETWEEN @from AND @to) OR ([Id] BETWEEN 142 AND 149)); and validate unordered result resultChangeApprovalBulkUpsert107.txt with ResultFormat = CSV and QueryType = Query Approved Data and Timeout = 60 seconds
		| Name | Value |
		| from | 5     |
		| to   | 8     |
	Then As User Builder Run cql from file selectChangeApprovalBulkUpsert56.txt and validate unordered result resultChangeApprovalBulkUpsert108.txt with ResultFormat = CSV and QueryType = Including Version History and Timeout = 60 seconds
		| Name | Value |
		| from | 5     |
		| to   | 8     |

@Rest
Scenario: CA - As Builder, Bulk Upsert into a Multi Select Link Column where User is able to view all rows
	Given Cleanup Run cql statement Delete from [Mock].[EmployeeChangeApproval23] where [Cinchy Id] > 33; with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	And Cleanup Run cql statement UPDATE [Mock].[EmployeeChangeApproval23] SET [Approval State] = 'Approved' where [Cinchy Id] > 33 with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	When As User Builder Run Bulk Upsert cql statement INSERT INTO [Mock].[EmployeeChangeApproval23] ([Cinchy Id], [MSL],[Id]) VALUES (@data1,ResolveLink(@data2,'Date'),@data9); with Parameter:Column:Type as data1:Cinchy Id:Number,data2:MSL:Text,data9:Id:Number
		...
		|        | Dec 6 2020 | 46     |
		|        | Mar 3 2020 | 47     |
	Then As User Builder Run cql statement Select [MSL],[Id] from [Mock].[EmployeeChangeApproval23] WHERE [Deleted] IS NULL AND (([Cinchy Id] BETWEEN @from AND @to) OR ([Id] BETWEEN 34 AND 47)); and validate unordered result resultChangeApprovalBulkUpsert109.txt with ResultFormat = CSV and QueryType = Query Approved Data and Timeout = 60 seconds
		| Name | Value |
		| from | 9     |
		| to   | 10    |
	Then As User Builder Run cql statement SELECT DISTINCT [Version],[Draft Version],[MSL],[Id] from [Mock].[EmployeeChangeApproval23] WHERE [Deleted] IS NULL AND (([Cinchy Id] BETWEEN @from AND @to) OR ([Id] BETWEEN 34 AND 47)) ORDER BY [Id] DESC, [Version] DESC , [Draft Version] DESC and validate unordered result resultChangeApprovalBulkUpsert110.txt with ResultFormat = CSV and QueryType = Including Version History and Timeout = 60 seconds
		| Name | Value |
		| from | 9     |
		| to   | 10    |

@Rest
Scenario: CA - As Builder, Bulk Upsert into a Multi Select Choice Column where User is able to view all rows
	Given Cleanup Run cql statement Delete from [Mock].[EmployeeChangeApproval23] where [Cinchy Id] > 33; with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	And Cleanup Run cql statement UPDATE [Mock].[EmployeeChangeApproval23] SET [Approval State] = 'Approved' where [Cinchy Id] > 33 with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	When As User Builder Run Bulk Upsert cql statement INSERT INTO [Mock].[EmployeeChangeApproval23] ([Cinchy Id], [MSC],[Id]) VALUES (@data1,@data2,@data9) with Parameter:Column:Type as data1:Cinchy Id:Number,data2:MSC:Text,data9:Id:Number
		| Value1 | Value2                | Value9 |
		| 15     | Dance,Play            | 48     |
		| 16     | Jump,Sleep            | 49     |
		...
		|        | Dance,Play            | 56     |
		|        | Jump,Sleep            | 57     |
	Then As User Builder Run cql statement Select [MSC],[Id] from [Mock].[EmployeeChangeApproval23] WHERE [Deleted] IS NULL AND (([Cinchy Id] BETWEEN @from AND @to) OR ([Id] BETWEEN 48 AND 57)); and validate unordered result resultChangeApprovalBulkUpsert111.txt with ResultFormat = CSV and QueryType = Query Approved Data and Timeout = 60 seconds
		| Name | Value |
		| from | 15    |
		| to   | 16    |
	Then As User Builder Run cql statement SELECT DISTINCT [Version],[Draft Version],[MSC],[Id] from [Mock].[EmployeeChangeApproval23] WHERE [Deleted] IS NULL AND (([Cinchy Id] BETWEEN @from AND @to) OR ([Id] BETWEEN 48 AND 57)) ORDER BY [Id] DESC, [Version] DESC , [Draft Version] DESC and validate unordered result resultChangeApprovalBulkUpsert112.txt with ResultFormat = CSV and QueryType = Including Version History and Timeout = 60 seconds
		| Name | Value |
		| from | 15    |
		| to   | 16    |

@Rest
Scenario: CA - As Builder, Bulk Upsert into hierarchy link column using ResolveLink where User is able to view all rows
	Given Cleanup Run cql statement Delete from [Mock].[EmployeeChangeApproval23] where [Cinchy Id] > 33; with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	And Cleanup Run cql statement UPDATE [Mock].[EmployeeChangeApproval23] SET [Approval State] = 'Approved' where [Cinchy Id] > 33 with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	When As User Builder Run Bulk Upsert cql statement INSERT INTO [Mock].[EmployeeChangeApproval23] ([Cinchy Id], [Hlink], [Id]) VALUES (@data1,ResolveLink(@data2,'Employee ID'),@data9); with Parameter:Column:Type as data1:Cinchy Id:Number,data2:Hlink:Text,data9:Id:Number
		| Value1 | Value2                                             | Value9 |
		...
		|        | viewonly12                                         | 71     |
		|        | viewonly12                                         | 72     |
	Then As User Builder Run cql statement Select [Hlink],[Id] from [Mock].[EmployeeChangeApproval23] WHERE [Deleted] IS NULL AND (([Cinchy Id] BETWEEN @from AND @to) OR ([Id] BETWEEN 58 AND 72)); and validate unordered result resultChangeApprovalBulkUpsert113.txt with ResultFormat = CSV and QueryType = Query Approved Data and Timeout = 60 seconds
		| Name | Value |
		| from | 11    |
		| to   | 12    |
	Then As User Builder Run cql statement SELECT DISTINCT [Version],[Draft Version],[Hlink], [Id] from [Mock].[EmployeeChangeApproval23] WHERE [Deleted] IS NULL AND (([Cinchy Id] BETWEEN @from AND @to) OR ([Id] BETWEEN 58 AND 72)) ORDER BY [Id] DESC, [Version] DESC , [Draft Version] DESC and validate unordered result resultChangeApprovalBulkUpsert114.txt with ResultFormat = CSV and QueryType = Including Version History and Timeout = 60 seconds
		| Name | Value |
		| from | 11    |
		| to   | 12    |

@Rest
Scenario: CA - As Builder, Bulk Upsert into multi select hierarchy link column using ResolveLink where User is able to view all rows
	Given Cleanup Run cql statement Delete from [Mock].[EmployeeChangeApproval23] where [Cinchy Id] > 33; with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	And Cleanup Run cql statement UPDATE [Mock].[EmployeeChangeApproval23] SET [Approval State] = 'Approved' where [Cinchy Id] > 33 with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	When As User Builder Run Bulk Upsert cql statement INSERT INTO [Mock].[EmployeeChangeApproval23] ([Cinchy Id], [MSH], [Id]) VALUES (@data1,ResolveLink(@data2,'Employee ID'),@data9); with Parameter:Column:Type as data1:Cinchy Id:Number,data2:MSH:Text,data9:Id:Number
		| Value1 | Value2                                                                                   | Value9 |
	...
	Then As User Builder Run cql statement Select [MSH],[Id] from [Mock].[EmployeeChangeApproval23] WHERE [Deleted] IS NULL AND (([Cinchy Id] BETWEEN @from AND @to) OR ([Id] BETWEEN 73 AND 90)); and validate unordered result resultChangeApprovalBulkUpsert115.txt with ResultFormat = CSV and QueryType = Query Approved Data and Timeout = 60 seconds
		| Name | Value |
		| from | 13    |
		| to   | 14    |
	Then As User Builder Run cql statement SELECT DISTINCT [Version],[Draft Version],[MSH],[Id] from [Mock].[EmployeeChangeApproval23] WHERE [Deleted] IS NULL AND (([Cinchy Id] BETWEEN @from AND @to) OR ([Id] BETWEEN 73 AND 90)) ORDER BY [Id] DESC, [Version] DESC , [Draft Version] DESC and validate unordered result resultChangeApprovalBulkUpsert116.txt with ResultFormat = CSV and QueryType = Including Version History and Timeout = 60 seconds
		| Name | Value |
		| from | 13    |
		| to   | 14    |

@Rest
Scenario: CA - As Builder, Bulk Upsert into all column types where User is able to view all rows
	Given Cleanup Run cql statement Delete from [Mock].[EmployeeChangeApproval23] where [Cinchy Id] > 33; with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	And Cleanup Run cql statement UPDATE [Mock].[EmployeeChangeApproval23] SET [Approval State] = 'Approved' where [Cinchy Id] > 33 with ResultFormat = CSV and QueryType = Number Of Rows Affected and Timeout = 60 seconds
	When As User Builder Run Bulk Upsert cql from file insertChangeApprovalBulkUpsert12.txt with Parameter:Column:Type as data0:Cinchy Id:Number,data1:Job:Text,data2:Link Calculated Cache:Text,data3:Link CalculatedLink Cache:Text,data4:Manager:Text,data5:Person:Text,data6:Role:Text,data7:User:Text,data8:Name:Text,data9:Id:Number,data10:Start Date:DateTime,data11:Emergency Contact Number:Number,data12:Annual Base Compensation:Number,data13:Employee Term:Text,data14:Salaried:Boolean,data15:MSL:Text,data16:MSC:Text,data17:Hlink:Text,data18:MSH:Text
		...
		| 17     | Ajax    | FirstName Test2 LastName Test2 | Brazil Cinchy            | Plum   | Plum   | Select | viewonly                 | Automation99 | 91     | 15 Mar 2020 | 545455545 | 66000   | Co-op     | true    | Dec 6 2020 | Dance,Play            | Edit Selected Edit Row Filter currentUsersGroups12 | Edit Selected Edit Row Filter currentUsersGroups12,viewonly12                            |
	...
	Then As User Builder Run cql from file selectChangeApprovalBulkUpsert57.txt and validate unordered result resultChangeApprovalBulkUpsert117.txt with ResultFormat = CSV and QueryType = Query Approved Data and Timeout = 60 seconds
		| Name | Value |
		| from | 17    |
		| to   | 17    |
	Then As User Builder Run cql from file selectChangeApprovalBulkUpsert58.txt and validate unordered result resultChangeApprovalBulkUpsert118.txt with ResultFormat = CSV and QueryType = Including Version History and Timeout = 60 seconds
		| Name | Value |
		| from | 17    |
		| to   | 17    |