...
Scenario: BU - As user with edit selected columns and view selected columns, Insert into a Link Column that references cached calculated column type
	When As User View Selected Edit Selected Run Bulk Upsert cql from file insertBULinkColumn3.txt with Parameter:Column:Type as data0:Cinchy Id:Number,data1:Link Calculated Cached:Text
		| Value0 | Value1                         |
...
Scenario: BU - As user with edit selected columns and view selected columns, Insert into a Multi Select Link Column with no permission to that column
	When As User View Selected Edit Selected Run Bulk Upsert cql from file insertBUMultiLinkColumn1.txt with Parameter:Column:Type as data0:Cinchy Id:Number,data1:Name:Text,data2:MSL:Text
...
Scenario: BU - As user with edit selected columns and view selected columns, Insert into a Multi Select Choice Column with no permission to that column
	When As User View Selected Edit Selected Run Bulk Upsert cql from file insertBUMultiChoiceColumn1.txt with Parameter:Column:Type as data0:Cinchy Id:Number,data1:Name:Text,data2:MSC:Text
		| Value0 | Value1 | Value2          |
...
Scenario: BU - As user with edit selected columns and view selected columns, Insert into hierarchy link column using ResolveLink with no permission to that column
	When As User View Selected Edit Selected Run Bulk Upsert cql from file insertBUHierarchyColumn1.txt with Parameter:Column:Type as data0:Cinchy Id:Number,data1:HLink:Text
		| Value0 | Value1 |
		| 9      | Annie  |
		| 10     | Mark   |
		|        | Annie  |
...
Scenario: BU - As user with edit selected columns and view selected columns, Insert into table of columns types : Text, Number, Date, Yes/No, Single select choice columns
	When As User View Selected Edit Selected Run Bulk Upsert cql from file insertBulkUpsert99.txt with Parameter:Column:Type as data0:Cinchy Id:Number,data1:Start Date:DateTime,data2:Emergency Contact Number:Number,data3:Employee Term:Text,data4:Salaried:Boolean,data5:Name:Text
...
Scenario: BU - As user with edit selected columns and view selected columns, Insert into multi select hierarchy link column using ResolveLink
	When As User View Selected Edit Selected Run Bulk Upsert cql from file insertBUMultiHierarchyColumn1.txt with Parameter:Column:Type as data0:Cinchy Id:Number,data1:MSH:Text
		| Value0 | Value1 |
		| 9      | Annie  |
		| 10     | Mark   |
		|        | Annie  |
...
Scenario: BU - As user with edit selected columns and view selected columns, Insert into a Link Column using ResolveLink
	When As User View Selected Edit Selected Run Bulk Upsert cql from file insertBULinkColumn1.txt with Parameter:Column:Type as data0:Cinchy Id:Number,data1:Person:Text
		| Value0 | Value1  |
		| 9      | Annie   |
		| 10     | Apple   |
		|        | Apricot |
...
Scenario: BU - As user with edit selected columns and view selected columns, Insert into a Link Column that references simple column types
	When As User View Selected Edit Selected Run Bulk Upsert cql from file insertBULinkColumn2.txt with Parameter:Column:Type as data0:Cinchy Id:Number,data1:User:Text
		| Value0 | Value1 |
		| 9      | 1      |
		| 10     | 2      |
		|        | 1      |
...
Scenario: BU - As user with edit selected columns and view selected columns, Insert into live and Cached Calculated columns tha references simple column types, UDFs
	When As User View Selected Edit Selected Run Bulk Upsert cql from file insertBUCalculatedColumn.txt with Parameter:Column:Type as data0:Cinchy Id:Number,data1:Calculated Cache:Text,data2:Calculated Live:Text,data3:Live UDF:Text,data4:Cached UDF UDF:Text,data5:Name:Text
		| Value0 | Value1      | Value2 | Value3    | Value4 | Value5  |
		| 9      | 15 Mar 2020 | 66000  | Co-op     | Yes    | Annie   |
		| 10     | Dec 2 2020  | 67000  | Full Time | No     | Mark    |
		|        | Dec 3 2020  | 68000  | Part Time | Yes    | Apricot |
